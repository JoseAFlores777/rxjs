import { fromEvent, mergeAll, Observable, mergeMap } from 'rxjs';
import { pluck, map, take, debounceTime, switchMap  } from 'rxjs/operators';
...
input$
    ...
    //cancela las peticiones anteriorers y solo cuenta la ultima
